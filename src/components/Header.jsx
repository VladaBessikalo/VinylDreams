        ...
        <Box>
            <AppBar position="static" color="secondary" sx={{ paddingY: 1 }}>
                <Toolbar sx={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap'}}>
                    <Box sx={{ display: 'flex', alignItems: 'center' }} className="vinyl-logo">
                        <Link to="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none', color: 'inherit' }}>
                            <img src={vinylIcon} alt="Vinyl Icon" style={{ width: 40, height: 40, marginRight: 8 }} className="vinyl-logo__vinyl-icon"/>
                            <Typography variant="h6" sx={{ fontWeight: 700, fontStyle: "italic" }} className="vinyl-logo__text">
                                Vinyl Dreams
                            </Typography>
                        </Link>
                    </Box>
